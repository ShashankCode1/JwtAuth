...
public enum StatusCodeEnum {
    USER_REGISTRATION_SUCCESS("USER_REGISTRATION_SUCCESS", "User registered successfully"),
    USER_LOGGED_IN_SUCCESS("USER_LOGGED_IN_SUCCESS", "User logged in successfully"),
    GET_USER_PROFILE_SUCCESS("GET_USER_PROFILE_SUCCESS", "User profile fetched successfully"),
    PAYLOAD_VALIDATION_FAILED("PAYLOAD_VALIDATION_FAILED", "Exception occurred while validating payload"),
    ...
    MALFORMED_REQUEST("MALFORMED_REQUEST", "Exception occurred while processing malformed request"),
    INVALID_JWT_TOKEN("INVALID_JWT_TOKEN", "Exception occurred while validating JWT token"),
    MALFORMED_JWT_TOKEN("MALFORMED_JWT_TOKEN", "Exception occurred while decoding JWT token"),
    INVALID_JWT_SIGNATURE("INVALID_JWT_SIGNATURE", "Exception occurred while validating JWT signature"),
